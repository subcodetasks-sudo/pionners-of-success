...
const AccordionGallery = ({
  ...
  const handleClick = (i: number, event: React.MouseEvent<HTMLElement>) => {
    if (i !== active) {
  ...
  const handleKeyDown = (i: number, event: React.KeyboardEvent<HTMLElement>) => {
      ...
      {items.map((item, i) => {
        ...
        return (
          <Tag
            ...
            onFocus={() => setActive(i)}
            onKeyDown={(e: React.KeyboardEvent<HTMLElement>) => handleKeyDown(i, e)}
            role="listitem"
            tabIndex={0}
